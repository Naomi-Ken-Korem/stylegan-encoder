...
def main():
    ...
    parser.add_argument('--perc_model_path', default='https://drive.google.com/uc?id=1MEGjdvVpUsu1jB4zrXZN7Y4kBBOzizDQ', help='Fetch a StyleGAN model to train on from this URL') # karras2019stylegan-ffhq-1024x1024.pkl
    ...
    if (args.use_lpips_loss > 0.00000001):
        ...
        with dnnlib.util.open_url(args.perc_model_path, cache_dir=config.cache_dir) as f:
            perc_model =  pickle.load(f)
        # with open(args.perc_model_path, 'rb') as f:
        #     generator_network, discriminator_network, Gs_network = pickle.load(f)
